...
const STORAGE_KEYS = {
  ...
  CURRENT_SESSION: 'askmydocs-current-session',
  USER_ID: 'askmydocs-user-id'
};
...
const App: React.FC = () => {
  ...
  const setStorageItem = useCallback((key: string, value: any): boolean => {
    try {
      ...
      toast.error(`Failed to save ${key.replace('askmydocs-', '')}`);
      return false;
    }
  }, []);
    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-indigo-100">
      ...
      <div className="container mx-auto px-4 py-8">
        ...
        <div className="mb-4 p-2 rounded text-xs text-gray-600">
          Current: {currentSession?.name || 'None'}
        </div>
              ...
              <div className="space-y-8">
                <div className="text-center">
                  <h2 className="text-3xl font-bold text-gray-800 mb-4">
                    {sessions.length === 0 ? 'Welcome to AskMyDocs' : 'Create New Session'}
                  </h2>
